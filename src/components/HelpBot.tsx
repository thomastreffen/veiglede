    ...
    <>
      {!open && (
        <button
          ...
          className="fixed bottom-[calc(4rem+env(safe-area-inset-bottom))] right-[4.5rem] md:bottom-6 md:right-6 z-50 grid place-items-center h-12 w-12 md:h-14 md:w-14 rounded-full bg-primary text-primary-foreground shadow-lg shadow-primary/40 hover:brightness-110 transition"
        >
